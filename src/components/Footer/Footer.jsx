  ...
  return (
    <div className="w-full rounded-t-[40px] bg-gradient-to-b from-[#251621] to-[#42233A] px-8 ">
      ...
      <div className="max-w-7xl mx-auto pt-4">
        <p className="md:text-right text-[16px] text-[#EEEBED] leading[150%]">
          © 2025 Havenix. All rights reserved.
        </p>
      </div>
      <div className="text-[16vw] pt-16 text-center alexandria-600 leading-none bg-gradient-to-r from-[#8A7384] via-[#CAC3C3] to-[#CAC3C3] bg-clip-text text-transparent tracking-wider">
        <h4>WiztecBD</h4>
      </div>
    </div>
  );
